...
</li>`}function L(e){u.warning({message:e,position:"topRight"})}function h(e){u.error({message:e,position:"topRight",messageColor:"#fafafb",messageSize:"16px",maxWidth:"432px",backgroundColor:"rgb(239, 64, 64)",position:"topRight",progressBarColor:"rgb(181, 27, 27)"})}a.imageSearchForm.addEventListener("submit",S);a.loadMoreBtn.addEventListener("click",w);let c=1,y=100,m,v,d;function S(e){if(e.preventDefault(),d=e.currentTarget.elements.searchImage.value.trim(),a.gallery.innerHTML="",e.currentTarget.reset(),d===""){L("Write what image you want to search for");return}g(a.loader),l(a.loadMoreBtn),c=1,p(d,c,y).then(r=>{if(!r.data.totalHits){h("Sorry, there are no images matching your search query. Please try again!"),l(a.loadMoreBtn);return}m=r.data.totalHits,console.log(m),v=Math.ceil(m/15);const s=f(r.data.hits);a.gallery.innerHTML=s,l(a.loader),g(a.loadMoreBtn)})}function w(){if(a.loader.style.order=3,g(a.loader),c>v){h("We're sorry, but you've reached the end of search results"),l(a.loadMoreBtn);return}p(d,c,y).then(e=>{c+=1;const r=f(e.data.hits);a.gallery.insertAdjacentHTML("beforeend",r),l(a.loader),g(a.loadMoreBtn)}).catch(e=>{console.log(e)})}
