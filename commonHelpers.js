...
</li>`}function v(e){p.warning({message:e,position:"topRight"})}function u(e){p.error({message:e,position:"topRight",messageColor:"#fafafb",messageSize:"16px",maxWidth:"432px",backgroundColor:"rgb(239, 64, 64)",position:"topRight",progressBarColor:"rgb(181, 27, 27)"})}function P(){const t=document.querySelector(".gallery-item").getBoundingClientRect().height;window.scrollBy({top:t*2,behavior:"smooth"})}o.imageSearchForm.addEventListener("submit",B);o.loadMoreBtn.addEventListener("click",I);let c=0,d=15,f,b,M=new L(".gallery a"),g;function B(e){if(e.preventDefault(),o.gallery.innerHTML="",g=e.currentTarget.elements.searchImage.value.trim(""),g===""){u("Write what image you want to search for");return}e.currentTarget.reset(),c=1,l(o.loadMoreBtn),m(o.loader),h(g,c,d).then(t=>{if(t.data.totalHits===0){u("No images found"),l(o.loader);return}const s=y(t.data.hits);return o.gallery.innerHTML=s,t}).then(t=>{f=t.data.totalHits,b=Math.ceil(t.data.totalHits/d)}).then(()=>{f<=d?v("You've reached the end of the collection. No more images are left"):m(o.loadMoreBtn),l(o.loader)}).catch(t=>{console.log(t)}).finally(()=>{M.refresh()})}function I(){c+=1,l(o.loadMoreBtn),o.loader.style.order=3,m(o.loader),h(g,c,d).then(e=>{console.log(e);const t=y(e.data.hits);o.gallery.insertAdjacentHTML("beforeend",t),P()}).catch(e=>{console.log(e)}).finally(()=>{c>b?v("You've reached the end of the collection. No more images are left"):m(o.loadMoreBtn),l(o.loader),M.refresh()})}
