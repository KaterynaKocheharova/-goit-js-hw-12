...
</li>`}function v(t){p.warning({message:t,position:"topRight"})}function u(t){p.error({message:t,position:"topRight",messageColor:"#fafafb",messageSize:"16px",maxWidth:"432px",backgroundColor:"rgb(239, 64, 64)",position:"topRight",progressBarColor:"rgb(181, 27, 27)"})}o.imageSearchForm.addEventListener("submit",P);o.loadMoreBtn.addEventListener("click",x);let c=0,g=15,f,b,M=new S(".gallery a"),d;function P(t){if(t.preventDefault(),o.gallery.innerHTML="",d=t.currentTarget.elements.searchImage.value.trim(""),d===""){u("Write what image you want to search for");return}t.currentTarget.reset(),c=1,l(o.loadMoreBtn),m(o.loader),h(d,c,g).then(e=>{if(e.data.totalHits===0){u("No images found"),l(o.loader);return}const s=y(e.data.hits);return o.gallery.innerHTML=s,e}).then(e=>{f=e.data.totalHits,b=Math.ceil(e.data.totalHits/g)}).then(()=>{f<=g?v("You've reached the end of the collection. No more images are left"):m(o.loadMoreBtn),l(o.loader)}).catch(e=>{console.log(e)}).finally(()=>{M.refresh()})}function x(t){console.log(d),c+=1,l(o.loadMoreBtn),o.loader.style.order=3,m(o.loader),h(d,c,g).then(e=>{console.log(e);const s=y(e.data.hits);o.gallery.insertAdjacentHTML("beforeend",s)}).catch(e=>{console.log(e)}).finally(()=>{c>b?v("You've reached the end of the collection. No more images are left"):m(o.loadMoreBtn),l(o.loader),M.refresh()})}
